...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-aws-plugin/owf-tstool-aws-plugin` folder
    and ***Select Folder***.
...
9.  Right click on `owf-tstool-aws-plugin` in ***Package Explorer*** or ***Project Explorer***
